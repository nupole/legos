...
class PcieTransactionLayerPacketHeaderCommonEncoderEnv(pyuvm.uvm_env):
    def build_phase(self):
        ...
        self.model = pvm.models.PcieTransactionLayerPacketHeaderCommonEncoderModel('model', self)
...
def test_pcie_transaction_layer_packet_header_common_encoder():
    runner = cocotb_tools.runner.get_runner('ghdl')

    current_dir = pathlib.Path().absolute()

    runner.test(test_module = 'test_pcie_transaction_layer_packet_header_common_encoder',
                hdl_toplevel = 'pcie_transaction_layer_packet_header_common_encoder_tb',
                hdl_toplevel_library = 'hdl_pcie_transaction_layer_packet_header_common_encoder_tb',
