...
class PcieTransactionLayerPacketHeaderCommonFmtDecoderEnv(pyuvm.uvm_env):
    def build_phase(self):
        ...
        self.model = pvm.models.ProtocolDecoderModel('model', self, pvm.decoders.PcieTransactionLayerPacketHeaderCommonFmtDecoder(int(cocotb.top.UPSTREAM_WORD_WIDTH.value)))
