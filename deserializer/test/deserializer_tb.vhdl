...
entity deserializer_tb is
    generic(OPERAND_DATA_WIDTH: positive := 1;
            RESULT_WIDTH:       positive := 4);
    port(clk:                     in  std_logic;
         rst:                     in  std_logic;
         ready_operand:           out std_logic;
         valid_operand:           in  std_logic;
         operand_number_of_words: in  unsigned((log2(RESULT_WIDTH/OPERAND_DATA_WIDTH)-1) downto 0);
...
begin
    dut: entity hdl_deserializer.deserializer generic map(OPERAND_DATA_WIDTH => OPERAND_DATA_WIDTH,
