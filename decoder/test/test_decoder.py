...
class DecoderEnv(pyuvm.uvm_env):
    def build_phase(self):
        ...
        self.model = pvm.models.DecoderModel('model', self)
...
@pyuvm.test()
class DecoderTest(pyuvm.uvm_test):
    def build_phase(self):
...
def test_decoder():
    ...
    runner.test(test_module = 'test_decoder',
                hdl_toplevel = 'decoder_tb',
                hdl_toplevel_library = 'hdl_decoder_tb',
